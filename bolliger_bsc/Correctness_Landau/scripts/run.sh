...
#srun ./LandauDamping  $N1 $N2 $N3 83886080 800 PCG 0.05 LeapFrog $preconditioner $P1 $P2 $P3 --overallocate 2.0 --info 10 --kokkos-map-device-id-by=mpi_rank


#run for CG without preconditioning:

srun ./LandauDamping  $N1 $N2 $N3 83886080 800 CG 0.05 LeapFrog --overallocate 2.0 --info 10 --kokkos-map-device-id-by=mpi_rank
