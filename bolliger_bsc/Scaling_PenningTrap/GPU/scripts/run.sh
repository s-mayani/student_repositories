...
#srun ./PenningTrap $N1 $N2 $N3 134217728 20 PCG 0.05 LeapFrog $preconditioner $P1 $P2 $P3 --overallocate 2.0 --info 10 --kokkos-map-device-id-by=mpi_rank


#run for CG without preconditioning:

srun ./PenningTrap $N1 $N2 $N3 134217728 20 CG 0.05 LeapFrog --overallocate 2.0 --info 10 --kokkos-map-device-id-by=mpi_rank
