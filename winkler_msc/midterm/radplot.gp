...
#plot 'cumulative_radiation.txt' w lines lw 2 title "Cumulative Radiation over sphere", \
#'cumulative_radiation.txt' u 1:($1 * ($2 - $2 + 24.1)) w lines title "Cumulative Larmor",